...
export default function Pro_Detail(){
    ...
    const id = params.id //dynamic id ye se milengi
    ...
    return(
        ...
        <Image src={item.img3} alt="productdetail" className="w-full h-[95%]" width={200} height={100}></Image>
        </div>
        {/*right div */}
        ...
        <p>This graphic t-shirt which is perfect for any occasion. Crafted from a soft and breathable fabric, 
            ...
            <div className="mt-5">
                ...
                <div className="w-[37px] h-[37px] bg-[#4F4631] rounded-full relative flex justify-center items-center"><Check className="text-white opacity-0 hpver:opacity-100 cursor-pointer"/></div>
                <div className="w-[37px] h-[37px] bg-[#314F4A] rounded-full relative flex justify-center items-center"><Check className="text-white opacity-0 hpver:opacity-100 cursor-pointer"/></div>
                <div className="w-[37px] h-[37px] bg-[#31344F] rounded-full relative flex justify-center items-center"><Check className="text-white opacity-0 hpver:opacity-100 cursor-pointer"/></div>
            </div>
            </div>
            {/*choose size*/}
            <div className="mt-4 ">
